...
export default function Home() {
  return (
    <div className="min-h-screen bg-orange-50 text-slate-900 font-sans">
      ...
      {/* 1. Hero Section */}
      <section className="relative px-6 py-20 md:py-32 bg-orange-500 text-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 z-10 relative">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end pr-0 md:pr-12">
            <div className="bg-white p-4 md:p-8 rounded-3xl shadow-2xl ring-4 ring-orange-200">
              <img
                src="/hero-child.png"
                alt="Lösemili çocuk"
      ...
      <section className="py-24 px-6 md:px-12 max-w-5xl mx-auto rounded-3xl my-12 relative">
        <div className="absolute inset-0 bg-white -z-10 rounded-3xl shadow-sm" />

        {/* Dekor: turuncu şeritler */}
        <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-orange-300 via-orange-500 to-orange-300 rounded-t-3xl" />
        <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-orange-300 via-orange-500 to-orange-300 rounded-b-3xl" />
