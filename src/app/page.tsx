      ...
      <section className="relative px-6 py-32 md:py-48 flex flex-col items-center justify-center text-center bg-gradient-to-br from-red-600 to-red-800 text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#bagis-noktalari" className="group flex items-center justify-center gap-2 px-8 py-4 bg-white text-red-600 rounded-full font-bold text-lg hover:bg-slate-100 hover:scale-105 transition-transform duration-300 shadow-lg cursor-pointer">
